                        ...
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td class="td-btns">
                                <div class="btn-group">
                                    <a href="?accion=editar&id=${item.getIdGrado()}" title="Editar" class="btn bg-green"><span class="fa fa-fw fa-edit"></span> </a>
                                    <a href="javascript:void(confirmarAccion('?accion=eliminar&id=${item.getIdGrado()}'))" title="Eliminar" class="btn btn-danger"><span class="fa fa-fw fa-remove"></span> </a>
                                  </div>
                              </td>
                              <td>${item.getIdGrado()}</td>
                              <td>${item.getNombreGrado()}</td>
                              <td>${item.getNivel()}</td>
