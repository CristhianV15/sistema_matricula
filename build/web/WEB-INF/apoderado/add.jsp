                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                      <div class="box-header with-border">
                        <h3 class="box-title">Agregar ${modulo.getTitulo()}</h3>
                      </div><!-- /.box-header -->
                      <!-- form start -->
                      <form role="form" action="?accion=agregar-guardar" method="post" autocomplete="off">
                        <div class="box-body">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="numDocumentoA"  required>
                          </div>
                            <div class="form-group">
                               <label>Correo electronico</label>
                            <input type="text" class="form-control" name="emailA"  required>
                          </div>
                            <div class="form-group">
                               <label>N&uacute;mero de celular</label>
                            <input type="text" class="form-control" name="celularA"  required>
                          </div>
                            <div class="form-group">
                           ...
                           <div class="row">
                            <label class="col-sm-12">Estado</label>
                              <div class="col-sm-6">
                            <select class="form-control input-width-auto" name="estadoA" required>
                              <option></option>
