              ...
              <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                      ...
                      <!-- form start -->
                      <form role="form" action="?accion=editar-guardar&id=${obj.getIdSeccion()}" method="post" autocomplete="off">
                        <div class="box-body">
                          <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" class="form-control" name="nombre" required value="${obj.getNombreSeccion()}">
                          </div>
                          <div class="form-group">
                           <div class="row">
