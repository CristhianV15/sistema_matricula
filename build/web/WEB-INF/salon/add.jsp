                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="ciclo" required>
                                ...
                                <c:forEach items="${ciclos}" var="ciclo">
                                    <option value="${ciclo.getIdCiclo()}">${ciclo.getNombreCiclo()}</option>
                                </c:forEach>                
                            </select>
                          </div>
                          <div class="form-group">
                            ...
                            <select class="form-control" name="grado" required>
                                ...
                                <c:forEach items="${grados}" var="grado">
                                    <option value="${grado.getIdGrado()}">${grado.getNombreGrado()}</option>
                                </c:forEach>
                            </select>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="seccion" required>
                                ...
                                <c:forEach items="${seccions}" var="seccion">
                                    <option value="${seccion.getIdSeccion()}">${seccion.getNombreSeccion()}</option>
                                </c:forEach>
                            </select>
                          </div>
                          <div class="form-group">
                            <label>Vacantes</label>
                            <input type="number" class="form-control" name="vacantes" min="0" >
                          </div>
                          <div class="form-group">
                           <div class="row">
