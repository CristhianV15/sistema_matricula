...
public class CicloServlet extends HttpServlet {
    private final String pathView = "/WEB-INF/ciclo/" ;
    private final String pathUrl = "./ciclo" ;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        modulo.setTitulos("Ciclos");
        modulo.setTitulo("Ciclo");
        modulo.setPathView(pathView);
        modulo.setPathUrl(pathUrl);
        modulo.setMenuItem("ciclo");
        ...
        switch(accion){
            case "":                 
                ...
                List<Ciclo> listado = ciclodao.all();
