              ...
              <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                      ...
                      <!-- form start -->
                      <form role="form" action="?accion=editar-guardar&id=${obj.getIdCiclo()}" method="post" autocomplete="off">
                        <div class="box-body">
                          <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" class="form-control" name="nombre" required value="${obj.getNombreCiclo()}">
                          </div>
                          <div class="form-group">
                           <div class="row">
