              ...
              <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                      ...
                      <!-- form start -->
                      <form role="form" action="?accion=editar-guardar&id=${obj.getIdGrado()}" method="post" autocomplete="off">
                        <div class="box-body">
                          <div class="form-group">
                            <label>Descripcion</label>
                            <input type="text" class="form-control" name="nombre" required value="${obj.getNombreGrado()}">
                          </div>
                          <div class="form-group">
                            <label>Nivel</label>
                            <input type="text" class="form-control" name="nivel" required value="${obj.getNivel()}">
                          </div>
                          <div class="form-group">
                            <label>Rotulo</label>
                            <input type="text" class="form-control" name="rotulo" required value="${obj.getRotulo()}">
                          </div>
                          <div class="form-group">
                           <div class="row">
