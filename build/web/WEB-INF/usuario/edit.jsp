              ...
              <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                      ...
                      <!-- form start -->
                      <form role="form" action="?accion=editar-guardar&id=${obj.getIdUsuario()}" method="post" autocomplete="off">
                        <div class="box-body">
                          <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" class="form-control" name="nombre" required value="${obj.getNombreUsuario()}">
                          </div>
                          <div class="form-group">
                            <label>Clave</label>
                            <input type="password" class="form-control" name="clave" required value="${obj.getClave()}">
                          </div>
                          <div class="form-group">
                              <label>Tipo</label>
                            <input type="text" class="form-control" name="tipo" required value="${obj.getTipo()}">
                          </div>
                          <div class="form-group">
                            <label>Email</label>
                            <input type="text" class="form-control" name="email" required value="${obj.getEmail()}">
                          </div>
                          <div class="form-group">
                           <div class="row">
